...
<body>
  ...
  <div class="announce" role="region" aria-label="Announcement">
    <div class="announce-inner container">
      <span class="announce-pill"><span class="dot" aria-hidden="true"></span> Annual tuition: <strong>$399/year</strong> (billed annually)</span>
      <span class="announce-pill">14-day money-back guarantee</span>
    </div>
  </div>
